          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select agent to chat with</div>
                <div 
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat version of the report generation agent, can call 4 professional tools, has complete memory of MicroFish</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Align real-world seed data with simulated environment state, combined with Global/Local Memory mechanism, provides deep attribution analysis across time and space</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal algorithm, reconstructs event propagation paths, captures topological structure of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch Fast Search</div>
                    <div class="tool-desc">GraphRAG-based instant query interface, optimized index efficiency, used for quick extraction of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interview, can conduct multi-round conversations with individuals in simulated world in parallel, collects unstructured opinion data and mental states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to deeply understand the report content' : 'Chat with simulated individuals to understand their viewpoints' }}
              </p>
            </div>
            <div 
...
const selectAgent = (agent, idx) => {
  ...
  // Restore this Agent chat history
...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> when followed by block-level elements (caused by extra blank lines)
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean <br> before paragraph start tags after block-level elements
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Fix numbering for non-consecutive ordered lists: when a single <ol> is separated by paragraph content, keep incrementing
...
Now my new question is: ${message}`
  ...
  if (res.success && res.data) {
    ...
    // Convert object dictionary to array, prioritize getting reddit platform response
...
/* Fix ordered list numbering - use CSS counters to make multiple ol elements continue numbering */
.message-text {
