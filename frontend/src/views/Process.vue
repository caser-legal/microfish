<template>
  <div class="process-page">
    <!-- Top Navigation Bar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">MICROFISH</div>
    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph Visualization (display whenever data is available) -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading the document, LLM analyzes the content and automatically generates an ontology structure suitable for public opinion simulation (entity types + relationship types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Interface Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunk the document and call Zep API to build the knowledge graph, extracting entities and relationships
                </div>
              </div>
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files pending for upload, please return to homepage and try again'
    loading.value = false
    return
  }
  ...
  try {
    ...
    ontologyProgress.value = { message: 'Uploading files and analyzing document...' }
    ...
    if (pending.domain && pending.domain !== 'auto') {
      formDataObj.append('domain', pending.domain)
    }
...
const startGraphPolling = () => {
  ...
  // Fetch graph data automatically every 10 seconds
...
const renderGraph = () => {
  ...
  simulation.on('tick', () => {
    // Update all edge positions (including visible lines and transparent click areas)
