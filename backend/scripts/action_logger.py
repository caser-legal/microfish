"""
Action log recorder
Records each agent action during OASIS simulation, for backend monitoring use.
...
class PlatformActionLogger:
    """Single-platform action log recorder"""
...
class SimulationLogManager:
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Get the Twitter platform log recorder"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Get the Reddit platform log recorder"""
...
class ActionLogger:
    """
    Action log recorder (compatible with the old interface).
    Consider using SimulationLogManager instead.
    """
...
# Global log instance (compatible with the old interface)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Get the global log instance (compatible with the old interface)."""
