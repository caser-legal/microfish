"""
MicroFish Backend - Flask Application Factory
"""
...
def create_app(config_class=Config):
    ...
    if should_log_startup:
        logger.info("=" * 50)
        logger.info("MicroFish Backend Starting...")
        logger.info("=" * 50)
    ...
    @app.route('/health')
    def health():
        return {'status': 'ok', 'service': 'MicroFish Backend'}
    
    if should_log_startup:
        logger.info("MicroFish Backend Started")
