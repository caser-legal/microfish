...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Batch calls with individual retry for each failed item
        
        Args:
            items: List of items to process
            process_func: Processing function, receives single item as argument
            exceptions: Exception types to retry
            continue_on_failure: Whether to continue processing other items after single item failure
