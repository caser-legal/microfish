...
Used to persist project state on the server side, avoiding passing large amounts of data between frontend and backend interfaces
"""
...
class ProjectStatus(str, Enum):
    ...
    GRAPH_BUILDING = "graph_building"    # Graph being built
    GRAPH_COMPLETED = "graph_completed"  # Graph construction completed
...
class ProjectManager:
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            Project list, sorted by creation time in descending order
        """
        cls._ensure_projects_dir()
