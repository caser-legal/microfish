"""
Test that profile generation meets OASIS requirements.
Verify:
1. Twitter profiles are generated in CSV format
2. Reddit profiles are generated in detailed JSON format
"""
...
def show_expected_formats():
    ...
    print("\n" + "=" * 60)
    print("OASIS expected profile format")
    print("=" * 60)
